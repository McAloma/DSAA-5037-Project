...
from src.models.WSI_graph_walk import WSIGraphClassifier, GraphWalker
...
def train_and_evaluate_kfold(data, fnames, task, encode_name, embedding_dim,
    ...
    # 创建缓存目录
    cache_dir = f"data/cache_pooled_embeddings_{encode_name}"
...
def main(args):
    ...
    log_path = args.log_path or f"experiments/results/{args.encode_name}_GW_{args.task}_results.txt"
